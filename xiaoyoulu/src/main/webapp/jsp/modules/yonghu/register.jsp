...
<body style="background-image:url('/xiaoyoulu/img/back-img-bg.jpg') !important;background-size:cover;">
<!-- Pre Loader -->
<div class="loading">
    <div class="spinner">
                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="register">
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-12">
                                    <label>QQ</label>
                                    <input id="yonghuQq" name="yonghuQq" class="form-control"
                                           placeholder="QQ">
                                </div>
                                <div class="form-group col-md-12">
                                    <label>微信</label>
                                    <input id="yonghuWeixin" name="yonghuWeixin" class="form-control"
                                           placeholder="微信">
                                </div>
                                   <div class="form-group col-md-12">
                                       <label>性别</label>
                                ...
                                <div class="form-group col-md-12">
                                    <label>年龄</label>
                                    <input id="nianling" name="nianling" class="form-control"
                                           onchange="nianlingChickValue(this)"  placeholder="年龄">
                                </div>

                                <div class="form-group col-md-12">
                                    <label>其他信息</label>
                                    <input id="yonghuText" name="yonghuText" class="form-control"
                                           placeholder="其他信息">
                                </div>
                                <div class="form-group col-md-12">
