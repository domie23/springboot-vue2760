...
<!-- 手机号 -->
  ...
  <!-- 邮箱 -->
                ...
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">地址:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="yonghuAddress" id="yonghuAddress"  placeholder="地址"  lay-verify="required" autocomplete="off" class="layui-input" style="width: 600px;">
                        </div>
                    </div>
                </div>
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">QQ:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="yonghuQq" id="yonghuQq"  placeholder="QQ"  lay-verify="required" autocomplete="off" class="layui-input" style="width: 600px;">
                        </div>
                    </div>
                </div>
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">微信:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="yonghuWeixin" id="yonghuWeixin"  placeholder="微信"  lay-verify="required" autocomplete="off" class="layui-input" style="width: 600px;">
                        </div>
                    </div>
                </div>
                <div class="layui-form-item layui-form-text input">
                ...
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">年龄:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="nianling" id="nianling"  lay-verify="integer|required"   placeholder="年龄" autocomplete="off" class="layui-input" style="width: 600px;">
                        </div>
                    </div>
                </div>
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">其他信息:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="yonghuText" id="yonghuText"  placeholder="其他信息"  lay-verify="required" autocomplete="off" class="layui-input" style="width: 600px;">
                        </div>
                    </div>
                </div>
