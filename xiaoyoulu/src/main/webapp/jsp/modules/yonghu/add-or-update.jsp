                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 当前表的字段 -->
                                    ...
                                    <div class="form-group col-md-6 yonghuNameDiv">
                                        <label>用户姓名</label>
                                        <input style="width: 450px" id="yonghuName" name="yonghuName" class="form-control"
                                               placeholder="用户姓名">
                                    </div>
                                    <div class="form-group col-md-6 yonghuPhoneDiv">
                                        <label>用户手机号</label>
                                    ...
                                    <div class="form-group col-md-6 yonghuPhotoDiv">
                                        <label>用户照片</label>
                                    ...
                                    <div class="form-group col-md-6 nianlingDiv">
                                        <label>年龄</label>
                                        <input style="width: 450px" id="nianling" name="nianling" class="form-control"
                                               onchange="nianlingChickValue(this)"  placeholder="年龄">
                                    </div>

                                    <div class="form-group col-md-6 yonghuTextDiv">
                                        <label>其他信息</label>
                                        <textarea style="width: 450px"  id="yonghuText" name="yonghuText" class="form-control"placeholder="其他信息"></textarea>
                                    </div>
    ...
    function validform() {
        return $("#addOrUpdateForm").validate({
            ...
            messages: {
                ...
                yonghuPhoto: "用户照片不能为空",
                yonghuEmail: "电子邮箱不能为空",
                yonghuAddress: "地址不能为空",
                yonghuQq: "QQ不能为空",
                yonghuWeixin: "微信不能为空",
                sexTypes: "性别不能为空",
                nianling: "年龄不能为空",
