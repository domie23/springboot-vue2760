...
<div id="app">
    ...
    <div class="ng-container ng-fault">
        <div class="ng-inmod ng-fault ng-paddor ng-bg-assist">
            <div class="ng-inmod-ini">
                ...
                <div class="ng-incontlst ng-fault ng-container ng-ai-drive1_map" aos="fade-up">
                    <div class="gallery">
                        <div class="row">
                            <div class="col-md-3" v-for="(item,index) in banjixiangceList" >
        ...
        <div class="ng-inmod ng-fault ng-paddor ng-bg-assist">
            <div class="ng-inmod-ini">
                    <div class="index_titlebox">
                        <h3 class="index_title">通讯录展示</h3>
                        <p class="index_intro">DATA SHOW</p>
                    </div>
                <div class="ng-incontlst ng-fault ng-container ng-ai-drive1_map" aos="fade-up">
                    <div class="gallery">
                        <div class="row">
                            <div class="col-md-3" v-for="(item,index) in yonghuList" >
                                <div class="galry-grid grid-top-rgt">
                                    <a href="javascript:return false;"  @click="jumpCheck('../yonghu/detail.jsp?id='+item.id , item.aaaaaaaaaa == null?'':item.aaaaaaaaaa , item.shangxiaTypes == null?'':item.shangxiaTypes)">
                                        <img class="img-responsive zoom-img" :src="item.yonghuPhoto?item.yonghuPhoto.split(',')[0]:''" style="height: 350px;width:100%;"/>
                                        <div class="w3agile-text">
                                            <h5>
                                                <span>{{item.yonghuName}}</span>
                                                <br/>
                                                <span v-if="item.yonghuNewMoney">
                                                    {{item.yonghuNewMoney}} RMB
                                                </span>
                                                <span v-else>
                                                    {{item.yonghuValue}}
                                                </span>
        ...
        <div class="ng-inmod ng-fault ng-paddor ng-bg-assist">
            <div class="ng-inmod-ini">
                    <div class="index_titlebox">
                        <h3 class="index_title">公告信息展示</h3>
                        <p class="index_intro">DATA SHOW</p>
                    </div>
                <div class="ng-incontlst ng-fault ng-container ng-ai-drive1_map" aos="fade-up">
                    <div class="gallery">
                        <div class="row">
                            <div class="col-md-3" v-for="(item,index) in gonggaoList" >
                                <div class="galry-grid grid-top-rgt">
                                    <a href="javascript:return false;"  @click="jumpCheck('../gonggao/detail.jsp?id='+item.id , item.aaaaaaaaaa == null?'':item.aaaaaaaaaa , item.shangxiaTypes == null?'':item.shangxiaTypes)">
                                        <img class="img-responsive zoom-img" :src="item.gonggaoPhoto?item.gonggaoPhoto.split(',')[0]:''" style="height: 350px;width:100%;"/>
                                        <div class="w3agile-text">
                                            <h5>
                                                <span>{{item.gonggaoName}}</span>
                                                <br/>
                                                <span v-if="item.gonggaoNewMoney">
...
<script>
    ...
    layui.use(['layer', 'form', 'element', 'carousel', 'http', 'jquery'], function () {
        ...
        http.request(`banjixiangce/list`, 'get', {
            ...
            vue.banjixiangceList = res.data.list;
        });
