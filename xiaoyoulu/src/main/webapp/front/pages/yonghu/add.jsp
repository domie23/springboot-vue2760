...
<!-- 手机号 -->
    ...
    <!-- 邮箱 -->
            <div class="layui-form-item layui-form-text input">
                ...
                <div class="layui-input-block">
                    <input <%--v-model="detail.yonghuAddress"--%> type="text" name="yonghuAddress" id="yonghuAddress" placeholder="地址" lay-verify="required" autocomplete="off"
                           class="layui-input">
                </div>
            </div>
            ...
            <div class="layui-form-item" pane>
                ...
                <div class="layui-input-block">
                    <input <%--v-model="detail.yonghuQq"--%> type="text" name="yonghuQq" id="yonghuQq" placeholder="QQ" lay-verify="required" autocomplete="off"
                           class="layui-input">
                </div>
            </div>
            ...
            <div class="layui-form-item" pane>
                ...
                <div class="layui-input-block">
                    <input <%--v-model="detail.yonghuWeixin"--%> type="text" name="yonghuWeixin" id="yonghuWeixin" placeholder="微信" lay-verify="required" autocomplete="off"
                           class="layui-input">
                </div>
            </div>
            ...
            <div class="layui-form-item" pane>
                ...
                <div class="layui-input-inline">
                    <input <%--v-model="detail.nianling"--%> type="text" name="nianling" id="nianling" lay-verify="integer|required"   placeholder="年龄" autocomplete="off" class="layui-input">
                </div>
            </div>
<!-- text后缀 -->
            <div class="layui-form-item layui-form-text input">
                ...
                <div class="layui-input-inline">
                    <textarea v-model="detail.yonghuText" name="yonghuText" id="yonghuText"  lay-verify="required"   placeholder="其他信息" autocomplete="off" ></textarea>
                </div>
            </div>
